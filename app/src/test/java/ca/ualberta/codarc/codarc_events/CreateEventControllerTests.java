...
public class CreateEventControllerTests {
    ...
    public void validateAndCreateEvent_success_trimsFields_setsGeneratedIdAndQr_openTrue() {
        var res = controller.validateAndCreateEvent(
                NAME, DESC, EVENT_AT, LOCATION, REG_OPEN, REG_CLOSE, "" // capacity empty -> null
        );
    ...
    public void validateAndCreateEvent_missingName_fails() {
        var r = controller.validateAndCreateEvent("  ", DESC, EVENT_AT, LOCATION, REG_OPEN, REG_CLOSE, null);
    ...
    public void validateAndCreateEvent_missingEventDate_fails() {
        var r = controller.validateAndCreateEvent("Name", DESC, " ", LOCATION, REG_OPEN, REG_CLOSE, null);
        assertFalse(r.isValid());
    ...
    public void validateAndCreateEvent_missingRegOpen_fails() {
        var r = controller.validateAndCreateEvent("Name", DESC, EVENT_AT, LOCATION, " ", REG_CLOSE, null);
        assertFalse(r.isValid());
    ...
    public void validateAndCreateEvent_missingRegClose_fails() {
        var r = controller.validateAndCreateEvent("Name", DESC, EVENT_AT, LOCATION, REG_OPEN, " ", null);
        assertFalse(r.isValid());
    ...
    public void validateAndCreateEvent_capacity_parsesPositiveInt() {
        var r = controller.validateAndCreateEvent("Name", null, EVENT_AT, null, REG_OPEN, REG_CLOSE, "42");
    ...
    public void validateAndCreateEvent_capacity_zeroBecomesNull() {
        var r = controller.validateAndCreateEvent("Name", null, EVENT_AT, null, REG_OPEN, REG_CLOSE, "0");
        assertTrue(r.isValid());
    ...
    public void validateAndCreateEvent_capacity_negativeBecomesNull() {
        var r = controller.validateAndCreateEvent("Name", null, EVENT_AT, null, REG_OPEN, REG_CLOSE, "-7");
        assertTrue(r.isValid());
        assertNull(r.getEvent().getMaxCapacity());
    }
    ...
    public void validateAndCreateEvent_capacity_badStringBecomesNull() {
        var r = controller.validateAndCreateEvent("Name", null, EVENT_AT, null, REG_OPEN, REG_CLOSE, "lol");
        assertTrue(r.isValid());
        assertNull(r.getEvent().getMaxCapacity());
    }
    ...
    public void persistEvent_happyPath_forwardsToDbAddEvent() {
        var res = controller.validateAndCreateEvent("Name", DESC, EVENT_AT, LOCATION, REG_OPEN, REG_CLOSE, "10");
        assertTrue(res.isValid());
        Event e = res.getEvent();
